...
/**
 * Node used when displaying the readability graph to represent a tangible node that is the start.
 */
class TangibleStartStateNode extends TangibleStateNode implements StateNode {
     ...
     */
    TangibleStartStateNode(String label, String tooltip, int id){
